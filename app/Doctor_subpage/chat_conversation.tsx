...
// Defined OUTSIDE the main component so GiftedChat's memoisation cannot cache
// it as a stale closure. All playback state flows in as props.
...
export default function ChatConversation() {
        ...
        if (currentMessage.customType === 'audio' && currentMessage.customUrl) {
            ...
            return (
                <AudioPlayerBubble
                    ...
                    textColor={isDark ? themeColors.text : '#1E293B'}
    ...
    }, [currentAudioId, isAudioPlaying, audioDurations, audioPosition, currentUserObj, themeColors, isDark, handleAudioPlayPause]);
