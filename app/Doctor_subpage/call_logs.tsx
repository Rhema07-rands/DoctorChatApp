        ...
        return (
            <View style={styles.logItem}>
                ...
                <View style={styles.logContent}>
                    <Text style={styles.patientName}>{item.otherUserName || 'Unknown User'}</Text>
        ...
        <SafeAreaView style={styles.container}>
            ...
            {history.length === 0 ? (
                <View style={styles.emptyState}>
                    ...
                    <Text style={styles.emptySubtitle}>History of your video and audio calls will appear here.</Text>
                </View>
            ) : (
                <FlatList
                    data={history}
